...
document.onkeydown = function (evt) {
    ...
    DotNet.invokeMethodAsync('Common', 'JsKeyDown', evt.keyCode);
...
document.onkeyup = function (evt) {
    evt = evt || window.event;
    DotNet.invokeMethodAsync('Common', 'JsKeyUp', evt.keyCode);
...
document.onkeypress = function (evt) {
    evt = evt || window.event;
    DotNet.invokeMethodAsync('Common', 'JsKeyPress', evt.keyCode);
